...
INSERT INTO products (id, name, price, "categoryId", active, "createdAt", "updatedAt") VALUES
  ...
  ('26184cb4-cc94-48a4-95fe-5c9cd1afdef1', 'Michelada Aguila Ligth', 10000, 'cat-cocteleria', true, NOW(), NOW()),
  ('9f8bafb6-aba2-42e9-b1f1-03a49705f715', 'Michelada Corona', 12000, 'cat-cocteleria', true, NOW(), NOW()),
