  ...
  return (
    <div className="flex min-h-dvh flex-col gap-2 bg-[#0A0A0A] px-[5px] text-[#E8E0D0]">
      ...
      <header data-toolbar className="flex flex-wrap items-center gap-2">
        <img src="/logo.png" alt="Bárbaro's Logo" className={`h-[60px] w-auto object-contain mt-[15px] ${mode === 'admin' ? 'cursor-pointer' : ''}`} onClick={() => mode === 'admin' && setShowAdminSidebar(true)} />
